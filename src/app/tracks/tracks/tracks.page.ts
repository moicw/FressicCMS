...
export class TracksPage implements OnInit {
  ...
  header_title="New Uploaded Track";
  filelist = []
  user_info:any;
  lastResponse:any = [];
  data:any = [];
  ...
  close_music_modal()
  {
    ...
    var audio = <HTMLVideoElement>document.getElementById("audio_player_big");
    audio.pause();
    audio.src="";
    var audio_preview = <HTMLVideoElement>document.getElementById("audio_player_preview_big");
    audio_preview.pause();
    audio_preview.src="";
  ...
  track_detail(track)
  {
    ...
    this.selected_track_info = track;
    console.log(this.selected_track_info);
    console.log(this.selected_track_info.track_author);
   
    this.api.read_artist(this.selected_track_info.track_author).then((user_stat) => {
      this.selected_artist = user_stat;
      this.api.getUserLink(this.selected_track_info.track_author).then((result_userlink) => {
  ...
  async delete_new_request(musicid,authorid)
  {
      ...
      buttons: [
        {
          ...
          handler: () => {
            ...
            /*this.api.sendemail_data("mcwei1987@gmail.com","Track Reject","Hello Artist, \nWe are sorry to inform that your track have been rejected. \nThanks").then((result) => {
  ...
  async delete_new_request_modal(musicid,authorid)
  {
    document.getElementById("track_Modal").style.display = "none";
  ...
  async approve_new_request_modal(track,authorid)
  {
    document.getElementById("track_Modal").style.display = "none";
  ...
  async approve_new_request(track,authorid)
  {
